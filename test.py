...
def add_metrics_and_indicators(df):
    import ta  # Import here to delay loading ta
...
def prophet_forecast(data, periods):
    from prophet import Prophet  # Delay import to avoid initial loading issue
    from prophet.plot import plot_plotly  # Delay import
...
def analyze_sentiment(text):
    from textblob import TextBlob  # Delay import of TextBlob
